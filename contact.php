...
<body>
                                        ...
                                        <div class="header__megamenu">
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    ...
                                                    <div class="label">AA-Optics</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#"> labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ...</a>
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="header__megamenu__item">
                        ...
                        <div class="contact__widget">
                            <ul>
                                <li>
                                    ...
                                    <span>AA Optics Limited, Nairobi</span>
                                </li>
                                <li>
                                    <i class="fa fa-mobile"></i>
                                    <span>Phone: +2547-000-222-111</span>
                                </li>
                                <li>
                                    <i class="fa fa-envelope-o"></i>
                                    <span>Email: info@aaoptics.com</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="contact__form">
                            <div class="contact__form__title">
                                <h2>gET IN TOUCH</h2>
                                <p>Our experience as opticians is absolutely positive. We would like to hear from you our esteemed customer
                                . AA-Optics provide really quick suport; get in touch!</p>
                            </div>
                            <form action="#">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Jodli Web Solutions</a>
